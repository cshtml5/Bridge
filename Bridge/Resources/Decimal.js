...
//Static methods (for nullable values)
System.Decimal.clone = function (d) {
    if (d == "undefined") {
        return null;
    }
    return new System.Decimal(d, d.$precision);
};

System.Decimal.neg = function (d) {
    if (d == "undefined") {
        return null;
    }
    return new System.Decimal(d.value.negated(), d.$precision);
};

System.Decimal.add = function (d1, d2) {
    if (d1 == "undefined" || d2 == "undefined") {
        return null;
    }
    var d = new System.Decimal(d1.value.plus(System.Decimal.getValue(d2)));
    d.$precision = Math.max(d.value.decimalPlaces(), Math.max(d2.$precision || 0, d1.$precision));
    return d;
};

System.Decimal.sub = function (d1, d2) {
    if (d1 == "undefined" || d2 == "undefined") {
        return null;
    }
    var d = new System.Decimal(d1.value.minus(System.Decimal.getValue(d2)));
    d.$precision = Math.max(d.value.decimalPlaces(), Math.max(d2.$precision || 0, d1.$precision));
    return d;
};

System.Decimal.inc = function (d) {
    if (d == "undefined") {
        return null;
    }
    return new System.Decimal(d.value.plus(System.Decimal.getValue(1)), d.$precision);
};

System.Decimal.dec = function (d) {
    if (d == "undefined") {
        return null;
    }
    return new System.Decimal(d.value.minus(System.Decimal.getValue(1)), d.$precision);
};

System.Decimal.mul = function (d1, d2) {
    if (d1 == "undefined" || d2 == "undefined") {
        return null;
    }
    var d = new System.Decimal(d1.value.times(System.Decimal.getValue(d2)));
    d.$precision = Math.max(d.value.decimalPlaces(), Math.max(d2.$precision || 0, d1.$precision));
    return d;
};

System.Decimal.div = function (d1, d2) {
    if (d1 == "undefined" || d2 == "undefined") {
        return null;
    }
    var d = new System.Decimal(d1.value.dividedBy(System.Decimal.getValue(d2)));
    d.$precision = Math.max(d.value.decimalPlaces(), Math.max(d2.$precision || 0, d1.$precision));
    return d;
};

System.Decimal.mod = function (d1, d2) {
    if (d1 == "undefined" || d2 == "undefined") {
        return null;
    }
    var d = new System.Decimal(d1.value.modulo(System.Decimal.getValue(d2)));
    d.$precision = Math.max(d.value.decimalPlaces(), Math.max(d2.$precision || 0, d1.$precision));
    return d;
};

System.Decimal.equalsT = function (d1, d2) {
    if (d1 == "undefined" && d2 == "undefined") {
        return true;
    }
...
System.Decimal.ne = function (d1, d2) {
    if (d1 == "undefined" && d2 == "undefined") {
        return false;
    }
    else if (d1 == "undefined" || d2 == "undefined") {
...
System.Decimal.gt = function (d1, d2) {
    if (d1 == "undefined" || d2 == "undefined") {
        return false;
    }
...
System.Decimal.gte = function (d1, d2) {
    if (d1 == "undefined" || d2 == "undefined") {
        return false;
    }
    return d1.compareTo(d2) >= 0;
...
System.Decimal.lt = function (d1, d2) {
    if (d1 == "undefined" || d2 == "undefined") {
        return false;
    }
    return d1.compareTo(d2) < 0;
...
System.Decimal.lte = function (d1, d2) {
    if (d1 == "undefined" || d2 == "undefined") {
        return false;
    }
    return d1.compareTo(d2) <= 0;
...
System.Decimal.equals = function (d1, d2) {
    if (Bridge.is(d1, System.Decimal) && Bridge.is(d2, System.Decimal)) {
        return System.Decimal.equalsT(Bridge.unbox(d1, true), (Bridge.unbox(d2, true)));
    }
    return false;
}
